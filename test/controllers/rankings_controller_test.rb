...
class RankingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ranking" do
    assert_difference('Ranking.count') do
      post rankings_url, params: { ranking: { rank: @ranking.rank, translation_id: @ranking.translation_id } }
    end
  ...
  test "should update ranking" do
    patch ranking_url(@ranking), params: { ranking: { rank: @ranking.rank, translation_id: @ranking.translation_id } }
