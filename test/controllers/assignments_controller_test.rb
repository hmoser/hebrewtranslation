...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference('Assignment.count') do
      post assignments_url, params: { assignment: { due_date: @assignment.due_date, title: @assignment.title } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { due_date: @assignment.due_date, title: @assignment.title } }
