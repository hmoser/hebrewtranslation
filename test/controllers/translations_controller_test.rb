...
class TranslationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create translation" do
    assert_difference('Translation.count') do
      post translations_url, params: { translation: { original_id: @translation.original_id, translation: @translation.translation, user_id: @translation.user_id } }
    end
  ...
  test "should update translation" do
    patch translation_url(@translation), params: { translation: { original_id: @translation.original_id, translation: @translation.translation, user_id: @translation.user_id } }
